...
public class Stringer {
     ...
     * */
    public static String insertText(String source, final String insertText, final String textOnTheLeft, final String textOnTheRight) {
     ...
     *       Insert Text in-between two strings
     * */
    public static String insertText(File file, final String insertText, final String textOnTheLeft, final String textOnTheRight) {
        TextActioner actioner = new TextActioner() {
            @Override
            public String actOnLine(String line) {
                return insertString(line, insertText, textOnTheLeft, textOnTheRight);
     ...
     *
     * */
    public static String appendLineStart(String source, final String appendString) {
        TextActioner actioner = new TextActioner() {
            @Override
            public String actOnLine(String line) {
     ...
     *
     * */
    public static String appendLineStart(File source, final String appendString) {
        TextActioner actioner = new TextActioner() {
            @Override
            public String actOnLine(String line) {
                return appendString + line;
     ...
     *
     * */
    public static String appendLineEnd(String source, final String appendString) {
        TextActioner actioner = new TextActioner() {
            @Override
            public String actOnLine(String line) {
     ...
     *
     * */
    public static String appendLineEnd(File source, final String appendString) {
        TextActioner actioner = new TextActioner() {
            @Override
            public String actOnLine(String line) {
                return line + appendString;
     ...
     *
     * */
    public static String removeBetween(String source, final String removeText, final String textOnTheLeft, final String textOnTheRight) {
        TextActioner actioner = new TextActioner() {
            @Override
            public String actOnLine(String line) {
    ...
    public static String removeBetween(File file, final String removeText, final String textOnTheLeft, final String textOnTheRight) {
        TextActioner actioner = new TextActioner() {
            @Override
            public String actOnLine(String line) {
                return doRemoveBetween(line, removeText, textOnTheLeft, textOnTheRight);
    ...
    public static String removeLineStart(String source, final String removeText) {
        TextActioner actioner = new TextActioner() {
            @Override
            public String actOnLine(String line) {
    ...
    public static String removeLineStart(File file, final String removeText) {
        TextActioner actioner = new TextActioner() {
            @Override
            public String actOnLine(String line) {
                return line.startsWith(removeText) ? line.substring(removeText.length()) : line;
    ...
    public static String removeLineEnd(String source, final String removeText) {
        TextActioner actioner = new TextActioner() {
            @Override
            public String actOnLine(String line) {
    ...
    public static String removeLineEnd(File file, final String removeText) {
        TextActioner actioner = new TextActioner() {
            @Override
            public String actOnLine(String line) {
                return line.endsWith(removeText) ? line.substring(0, line.length() - removeText.length()) : line;
